    ...
    render() {
        ...
        return (
            <Switch>
                ...
                {/* Private Routes */}
                <PrivateRoute path="/profile" authenticated={authenticated} currentUser={currentUser} component={ProfilePage}/>
                <PrivateRoute path="/projects" authenticated={authenticated} currentUser={currentUser} component={ProjectsPage}/>
