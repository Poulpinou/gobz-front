...
import ChapterList from '../list/chapter/ChapterList'
import {
    Col,
    Row,
    Button,
        ...
        return (
            <Form>
                <Form.Group controlId="form-create-project-name">
                    ...
                    <Form.Control onChange={this.handleInputChange} type="text" placeholder={"Chapitre #" + (this.state.chapters.length + 1)} name="name" value={newChapter.name}/>
                </Form.Group>

                <Form.Group controlId="form-create-project-description">
                    <Form.Label>Description</Form.Label>
                    <Form.Control onChange={this.handleInputChange} as="textarea" rows={3} name="description" value={newChapter.description} />
                </Form.Group>
